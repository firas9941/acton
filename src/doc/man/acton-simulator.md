...
acton-simulator --- Run Acton's simplified TON development environment

## Synopsis

`acton simulator` [_options_] _command_
...
`acton simulator start` [_options_]

#### Options

{{#options command="acton simulator start"}}
...
`acton simulator airdrop` [_options_] _address_

#### Options

{{#options command="acton simulator airdrop"}}
...
`acton simulator mine` [_options_] [_n_]

#### Options

{{#options command="acton simulator mine"}}
...
`acton simulator increase-time` [_options_] _seconds_
...
`acton simulator set-time` [_options_] _timestamp_

#### Options

{{#options command="acton simulator set-time"}}
...
`acton simulator set-next-block-timestamp` [_options_] _timestamp_

#### Options

{{#options command="acton simulator set-next-block-timestamp"}}
...
`acton simulator status` [_options_]

#### Options

{{#options command="acton simulator status"}}
...
`acton simulator snapshot` [_options_] _command_
...
**Network** section for simulator environments. Changes preserve all
