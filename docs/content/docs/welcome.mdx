...
Use [Studio](/docs/studio/overview) for project tests and environments,
[Simulator](/docs/simulator/overview) for lightweight execution and forks, and
[Localnet](/docs/commands/localnet) for real TON validators in Docker.
See [Upgrade to Acton 1.2](/docs/upgrade-to-1-2) for changes from 1.1.
