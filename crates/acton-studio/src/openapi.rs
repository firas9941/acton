...
#[openapi(
    ...
    paths(
        ...
        crate::network_activity::get,
        crate::network_activity::save,
        crate::network_activity::start,
        crate::network_activity::stop,
    ...
    components(schemas(
        ...
        acton_localnet::NetworkHealth,
        acton_localnet::NetworkHealthStatus,
        acton_localnet::NetworkHealthSample,
        acton_localnet::ApiHealth,
        acton_localnet::ApiHealthStatus,
        acton_localnet::ServiceHealth,
        acton_localnet::ServiceHealthStatus,
        StudioWallet,
        SignWalletRequest,
        SignWalletResponse,
        crate::ApiCallStatus,
